    ...
    <div className="card card-compact bg-base-100 w-90 shadow-xl">
      ...
      <div className="card-body">
        ...
        <button
            className={`btn ${
              isAddedToCart
                ? "p-2 rounded-full bg-red-600 text-white   hover:bg-red-500 focus:outline-none focus:bg-red-500 "
                : "p-2 rounded-full bg-blue-600 text-white   hover:bg-blue-500 focus:outline-none focus:bg-blue-500"
            }`}
            onClick={(e) => {
              e.preventDefault();
              if (!isAddedToCart) {
