...
const Feed = () => {
  ...
  useEffect(() => {
    const fetchPosts = async () => {
      setLoading(true);
      try {
        const response = await fetch(`${API_URL}?limit=10&skip=${page}&delay=2000`);
            ...
            <div>
              ...
              <div className="mt-2 sm:flex sm:items-center sm:gap-2">
                <div className="flex items-center gap-1 text-gray-500">
                  ...
                  <p className="text-xs">{post.reactions.likes} Likes</p> | <p className="text-xs">{post.reactions.dislikes} Dislikes</p> | <p className="text-xs">{post.views} Views</p>
                </div>
